...
class Dataset(object):
    ...
    def parse(self, data):
        user_traj, user_sentiment, user_times = [
            [[] for j in range(self.user_num)] for i in range(3)
        ]
    ...
    def load_correlation_matrix(self):
        ...
        cor_mat = torch.tensor(
            cor_mat.toarray(), dtype=torch.float32, device="cuda:0"
        )  # device='cuda:0'
    ...
    def user_fn(self, insts):
        ...
        useridx = torch.tensor(useridx, device="cuda:0")  # device='cuda:0'
        ...
        return (
            ...
            sentiment,
            test_label,
        )  # , sequential_event, sequential_times
